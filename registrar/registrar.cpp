...
nl::json accept_eapp(const nl::json &data_json)
{
    return accept_eapp_db(data_json);
}
...
PYBIND11_MODULE(registrar, m)
{
    ...
    m.def("accept_eapp", &accept_eapp, "pass py::object to a C++ function that takes an nlohmann::json");
}