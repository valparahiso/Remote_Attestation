...
void read_nonce()
{
  ...
  ocall_print_buffer("\nAsking untrusted enclave host to receive the encrypted nonce from the verifier. . .\n");
...
void generate_and_send_attestation_report()
{
  ...
  ocall_print_buffer("\nAsking untrusted enclave host to send to verifier encrypted attestation report. . .\n");
